...
export const projects: projectType[] = [
  ...
  },
  {
    ...
    desc: "Point of Sale system can be used to update data in myBorgur website .it also handle cart function and data tracking for example how many item sold perday    ",
    img: "/POS.png",
