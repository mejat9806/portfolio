...
function Experince({
  ...
  if (position === "right") {
    return (
      <>
        <div className="" ref={experinceRef}>
          {/* experince list */}
          <m.div
            className="flex h-48 "
            initial={{ x: "-100px" }}
          ...
          >
            ...
            >
              <div className="w-1 h-full bg-gray-600 rounded relative">
                ...
                {isItbottom && (
                  <div className="absolute w-5 h-5 rounded-full ring-4 ring-slightDarkBlue ring-offset-1 bg-gradient-to-b from-blue-50 to-pink-100 ring-offset-darkpink -left-2 -bottom-5"></div>
                )}
              </div>
            </m.div>
            {/* right  */}
